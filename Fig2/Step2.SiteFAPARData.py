...
if __name__ == '__main__':
        ...
        for eachtile in tiles:
            ...
            for eachfile in Tiflist:
                ...
                try:
                    ...
                    tempfielddf = fielddf[(fielddf["HOURMIN"] < 12) & (fielddf["year"] == tempyear) & (
                                fielddf["DOY"] >= tempdoy - 2) & (fielddf["DOY"] <= tempdoy + 2) & (
                                                      fielddf["RSZA"] <= szavalue + 2) & (fielddf["RSZA"] >= szavalue - 2)]
    ...
    # df["fmask"]=fmaskbandlist
    df.to_csv("HLS_Field_L30_S30_2.csv")
